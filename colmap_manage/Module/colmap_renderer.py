...
class COLMAPRenderer(object):
    ...
    def main(
        ...
        gui_points = server.gui.add_slider(
            ...
            max=points.shape[0],
            step=1,
            initial_value=min(points.shape[0], 50_000),
        )
    ...
    def renderColmap(
        ...
        colmap_path = colmap_data_folder_path + 'sparse/0/'
        images_path = colmap_data_folder_path + 'images/'
